...
class ProductResourceIT {
    ...
    private static final Size DEFAULT_P_SIZE = Size.S;
    private static final Size UPDATED_P_SIZE = Size.M;
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getpSize()).isEqualTo(DEFAULT_P_SIZE);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].pSize").value(hasItem(DEFAULT_P_SIZE.toString())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.pSize").value(DEFAULT_P_SIZE.toString()))
    ...
    void putExistingProduct() throws Exception {
        ...
        assertThat(testProduct.getpSize()).isEqualTo(UPDATED_P_SIZE);
