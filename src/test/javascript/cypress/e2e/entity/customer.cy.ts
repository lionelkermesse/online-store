...
describe('Customer e2e test', () => {
  ...
  const customerSample = {
    ...
    lastName: 'Murazik',
    gender: 'MALE',
    email: 'm66ZqM@-cOmmB.unF.vj_n.Sq37.s0miZ1.el4N',
    phone: '(799) 547-8506 x40885',
    addressLine1: 'plug-and-play',
    city: 'Lake Malcolmfort',
    country: 'Belarus',
  };
  ...
  describe('new Customer page', () => {
    ...
    it('should create an instance of Customer', () => {
      ...
      cy.get(`[data-cy="email"]`).type('on@xRijl6.u_Mfw.fOXP').should('have.value', 'on@xRijl6.u_Mfw.fOXP');

      cy.get(`[data-cy="phone"]`).type('413-313-4630 x48021').should('have.value', '413-313-4630 x48021');

      cy.get(`[data-cy="addressLine1"]`).type('Electronics Health').should('have.value', 'Electronics Health');

      cy.get(`[data-cy="addressLine2"]`).type('management Generic').should('have.value', 'management Generic');

      cy.get(`[data-cy="city"]`).type('Grand Prairie').should('have.value', 'Grand Prairie');

      cy.get(`[data-cy="country"]`).type('Uzbekistan').should('have.value', 'Uzbekistan');
